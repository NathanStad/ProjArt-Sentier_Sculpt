    ...
    methods: {
        ...
        afficheRoute(tour) {
            ...
            etapesInversees.forEach((etape) => {
                ...
                const marker = new maplibregl.Marker({ color: couleur })
                    .setLngLat(this.coordonnesRecenter)
                    .addTo(map);
                ...
                if (etape.id !== this.etapeActive) {
                    ...
                    if (svgElement) {
                        ...
                        const etapeDepart = tour.etapes.find(
                            (etape) => etape.id === this.etapeActive
                        );
                ...
                marker.getElement().addEventListener("click", () => {
                    if (
                        this.etapeActive ==
                        marker.getElement().getAttribute("data-id")
                    ) {
        ...
        showTours(tours) {
            ...
            if (numero) {
                ...
                const recenter = [
                    tour.etapes[0].longitude,
                    tour.etapes[0].latitude,
                ];
                if (tour) {
                    map.setCenter([
                        tour.etapes[0].longitude,
